    ...
    <div className={`${props.className ?? ''} flex w-full flex-col`}>
      <textarea
        ...
        className={twMerge(
          ...
          props.noBorder
            ? ''
            : 'border border-aws-font-color-light/50 dark:border-aws-font-color-dark/50',
          props.className
        )}
        rows={props.rows ?? 1}
      ...
      />
      {props.label && (
        <div className="order-first text-sm text-dark-gray peer-focus:font-semibold peer-focus:italic peer-focus:text-aws-font-color-light dark:text-light-gray dark:peer-focus:text-aws-font-color-dark">
          {props.label}
        </div>
      )}
      {props.hint && (
