  ...
  return (
    <>
      <Button
        ref={buttonRef}
        className={twMerge(
          'relative bg-drawers-white-light dark:bg-aws-squid-ink-dark',
          props.className
        )}
        text
        icon={<PiList />}
      ...
      {isOpen && (
        <div
          ...
          <div
            className="flex w-full cursor-pointer items-center p-2 hover:bg-drawers-white-mist-light dark:hover:bg-aws-paper-dark"
            onClick={() => {
              setIsOpen(false);
          ...
          {/*<div className="flex w-full items-center px-2 hover:bg-drawers-white-mist-light dark:hover:bg-aws-paper-dark">*/}
          {/*  {isDarkTheme ? (*/}
          ...
          {/*</div>*/}
          <div
            className="flex w-full cursor-pointer items-center border-t p-2 hover:bg-drawers-white-mist-light dark:hover:bg-aws-paper-dark"
            onClick={() => {
              setIsOpen(false);
