...
const Select: React.FC<Props> = (props) => {
  ...
  return (
    <div className={props.className}>
      {props.label && (
        <div>
          <span className="text-sm dark:text-aws-font-color-dark">
            {props.label}
          </span>
        </div>
      )}
      <Listbox
        ...
        <div className={twMerge('relative')}>
          <Listbox.Button
            className={twMerge(
              'relative h-9 w-full cursor-default rounded border border-aws-font-color-light/50 py-1 pl-3 pr-10 text-left focus:outline-none dark:border-aws-font-color-dark/50 dark:text-aws-font-color-dark',
          ...
          <Transition
            ...
            leaveTo="opacity-0">
            <Listbox.Options className="absolute z-50 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black/5 focus:outline-none dark:bg-aws-ui-color-dark sm:text-sm">
