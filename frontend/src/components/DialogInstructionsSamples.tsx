...
const PromptSample: React.FC<PromptSampleProps> = (props) => {
  return (
    <div>
      <div>{props.title}</div>
      <div className="rounded bg-light-gray p-2 text-aws-font-color-light dark:bg-aws-ui-color-dark dark:text-aws-font-color-dark">
        {props.prompt.split('\n').map((s, idx) => (
          <div key={idx}>{s}</div>
        ))}
      </div>
      ...
      <div>
        ...
        <div className="mt-4">
          ...
          <a
            ...
            className="text-aws-sea-blue-light underline hover:text-aws-sea-blue-hover-light dark:text-aws-font-color-blue dark:hover:text-aws-sea-blue-hover-dark">
