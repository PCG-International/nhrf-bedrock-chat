    ...
    <label
      className={twMerge(
        ...
        props.icon
          ...
          : 'border bg-aws-sea-blue-light p-1 px-3 text-aws-font-color-white-light dark:border-aws-ui-color-dark dark:bg-aws-ui-color-dark dark:text-aws-font-color-white-dark',
